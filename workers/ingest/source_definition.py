...
KNOWN_SOURCES: dict[str, SourceDefinition] = {
    ...
    "gov24": SourceDefinition(
        ...
        robots_status=RobotsStatus.ALLOWED,
        allowed_hosts=["www.gov.kr", "gov.kr", "api.odcloud.kr"],
    ),
    "fanfandaero": SourceDefinition(
        source_key="fanfandaero",
        display_name="판판대로",
        base_url="https://www.fanfandaero.kr",
        category=SourceCategory.BUSINESS,
        execution_mode=ExecutionMode.WEB_SCRAPING,
        credential_requirement=CredentialRequirement.NONE,
        robots_status=RobotsStatus.ALLOWED,
        allowed_hosts=["www.fanfandaero.kr", "fanfandaero.kr"],
    ),
    "seoulshinbo": SourceDefinition(
        source_key="seoulshinbo",
        display_name="서울신용보증재단",
        base_url="https://www.seoulshinbo.co.kr",
        category=SourceCategory.BUSINESS,
        execution_mode=ExecutionMode.WEB_SCRAPING,
        credential_requirement=CredentialRequirement.NONE,
        robots_status=RobotsStatus.ALLOWED,
        allowed_hosts=["www.seoulshinbo.co.kr", "seoulshinbo.co.kr"],
    ),
    "myhome": SourceDefinition(
        source_key="myhome",
        display_name="마이홈 모집공고",
    ...
    "myhome_lttot": SourceDefinition(
        source_key="myhome_lttot",
        display_name="마이홈 분양공고",
        base_url="https://www.applyhome.co.kr",
        category=SourceCategory.YOUTH,
        execution_mode=ExecutionMode.API,
        credential_requirement=CredentialRequirement.NONE,
    ...
    "myhome_stock": SourceDefinition(
        source_key="myhome_stock",
        display_name="마이홈 임대재고",
        base_url="https://www.applyhome.co.kr",
        category=SourceCategory.YOUTH,
        execution_mode=ExecutionMode.API,
        credential_requirement=CredentialRequirement.NONE,
    ...
    "myhome_wait": SourceDefinition(
        source_key="myhome_wait",
        display_name="마이홈 입주대기",
        base_url="https://www.applyhome.co.kr",
        category=SourceCategory.YOUTH,
        execution_mode=ExecutionMode.API,
        credential_requirement=CredentialRequirement.NONE,
